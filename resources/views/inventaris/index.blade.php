                        ...
                        <tbody>
                            @foreach ($inventaries as $index => $inventaris)
                                <tr class="body-teble">
                                    ...
                                    <td>Rp. {{ number_format($inventaris->harga_beli, 0, '.', '.') }},-</td>
                                    ...
                                    <td class="text-center px-1 d-flex justify-content-center">
                                        ...
                                        <a href="#" class="btn btn-sm btn-edit me-2" data-id="{{ $inventaris->id }}">
                                            <i class=" bi bi-pencil-square text-white"></i>
                                        </a>
                                        <div>
                                            <form action="{{ route('inventaris.destroy', ['inventari' => $inventaris->id]) }}"
    ...
    <script>
        $(document).ready(function() {
            $('.btn-create').on('click', function(e) {
                ...
                $.get('/inventaris/create', function(data) {
